...
* TODO [59%] [37/62] DEADLINE: <2020-03-31 Tue>
...
** TODO Pow - enable to switch subscriptions on the fly (without the need to relogin -> no kurwa nie do zrobienia)
** TODO Optimizing IEx for Ecto (book)
