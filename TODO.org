...
* TODO [64%] [51/79] DEADLINE: <2020-03-31 Tue>
...
** HOLD Changing email -> can force change email: https://github.com/danschultzer/pow/issues/512
** STRT Migrate database, write seeds with a proper structure
** TODO UserRecords::IndexLive + TESTS
** TODO CRUD Dashboard->Tables + TESTS
** TODO Make Admin users/subcriptions connect live
