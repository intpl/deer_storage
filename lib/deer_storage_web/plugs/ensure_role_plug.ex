defmodule DeerStorageWeb.EnsureRolePlug do
  @moduledoc """
  This plug ensures that a user has a particular role.

  ## Example

      plug DeerStorageWeb.EnsureRolePlug, [:user, :admin]

      plug DeerStorageWeb.EnsureRolePlug, :admin

      plug DeerStorageWeb.EnsureRolePlug, ~w(user admin)a
  """
