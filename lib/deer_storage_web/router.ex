defmodule DeerStorageWeb.Router do
  ...
  pipeline :protected,
    do: plug(Pow.Plug.RequireAuthenticated, error_handler: DeerStorageWeb.AuthErrorHandler)

  pipeline :not_authenticated,
    do: plug(Pow.Plug.RequireNotAuthenticated, error_handler: DeerStorageWeb.AuthErrorHandler)
  ...
  scope "/", DeerStorageWeb do
    ...
    live_session :default_live_without_navigation,
      root_layout: {DeerStorageWeb.LayoutView, :without_navigation} do
    ...
    put "/registration/switch_subscription_id/:subscription_id",
    ...
    resources "/users", UserController, only: [:index] do
      ...
      put "/toggle_permission/:subscription_id/:permission_key",
          UserController,
          :toggle_permission
    end
    ...
    scope "/admin", Admin, as: :admin do
      ...
      resources "/users", UserController do
        ...
        put "/subscription_links/make_current/:subscription_id",
            UserSubscriptionLinkController,
            :make_current
  ...
  scope "/", DeerStorageWeb do
    ...
    live_session :default_without_navigation_for_shared_record,
      root_layout: {DeerStorageWeb.LayoutView, :without_navigation} do
      live "/share/:subscription_id/:shared_record_uuid", SharedRecordsLive.Show
    end

    get "/:subscription_id/shared_record/:shared_record_id/:file_id",
        SharedRecordFilesController,
        :download_file_from_shared_record

    get "/:subscription_id/shared_file/:shared_file_id/:file_id",
        SharedRecordFilesController,
