defmodule DeerStorageWeb.DeerRecordsLive.Index do
  ...
  import DeerStorageWeb.DeerRecordsLive.Index.SocketAssigns.{Subscription, EditingRecord, NewRecord, NewConnectedRecord, Records, OpenedRecords, ConnectingRecords, UploadingFiles}
  ...
  def handle_event("redirect_to_connected_record", %{"record_id" => record_id, "table_id" => table_id}, socket) do
    {:noreply, push_redirect(socket, to: Routes.live_path(DeerStorageWeb.Endpoint, DeerStorageWeb.DeerRecordsLive.Index, table_id, id: record_id))}
  end
