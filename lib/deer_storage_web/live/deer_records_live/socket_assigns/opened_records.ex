defmodule DeerStorageWeb.DeerRecordsLive.Index.SocketAssigns.OpenedRecords do
  ...
  import DeerStorage.DeerRecords, only: [
  ...
  def assign_opened_record_from_params(socket, record_id) when is_binary(record_id) do
    ...
    Ecto.NoResultsError -> push_redirect(socket, to: Routes.live_path(DeerStorageWeb.Endpoint, DeerStorageWeb.DeerRecordsLive.Index, socket.assigns.table_id))
  end
  ...
  defp shared_link_for_record(subscription_id, record_uuid) do
    Routes.live_url(DeerStorageWeb.Endpoint, DeerStorageWeb.SharedRecordsLive.Show, subscription_id, record_uuid)
  end

  defp shared_link_for_file(subscription_id, shared_file_uuid, file_id) do
    Routes.shared_record_files_url(DeerStorageWeb.Endpoint, :download_file_from_shared_file, subscription_id, shared_file_uuid, file_id)
  end
end
