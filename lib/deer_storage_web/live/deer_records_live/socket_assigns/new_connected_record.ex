defmodule DeerStorageWeb.DeerRecordsLive.Index.SocketAssigns.NewConnectedRecord do
  ...
  import DeerStorageWeb.DeerRecordsLive.Index.SocketAssigns.Helpers, only: [atomize_and_merge_table_id_to_attrs: 2, find_record_in_opened_records: 2]
  import DeerStorage.DeerRecords, only: [change_record: 3, check_limits_and_create_record: 3, connect_records!: 3]
  ...
  def assign_created_connected_record(%{assigns: %{new_record: new_record, opened_records: opened_records, new_record_connecting_with_record_id: connecting_with_record_id, current_subscription: subscription, cached_count: cached_count}} = socket, attrs) do
    ...
    {:ok, socket} = DeerStorage.Repo.transaction fn ->
