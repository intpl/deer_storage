defmodule DeerStorageWeb.DeerRecordsLive.Index.SocketAssigns.NewRecord do
  ...
  import DeerStorageWeb.DeerRecordsLive.Index.SocketAssigns.Helpers, only: [atomize_and_merge_table_id_to_attrs: 2]
  ...
  def assign_created_record(%{assigns: %{current_subscription: subscription, table_id: table_id, cached_count: cached_count}} = socket, attrs) do
