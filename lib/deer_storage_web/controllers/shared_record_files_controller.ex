defmodule DeerStorageWeb.SharedRecordFilesController do
  ...
  def download_file_from_shared_file(conn, %{"subscription_id" => subscription_id, "shared_file_id" => shared_file_id, "file_id" => file_id}) do
    shared_file = SharedFiles.get_file!(subscription_id, shared_file_id, file_id) |> DeerStorage.Repo.preload([:deer_record, :subscription])
  ...
  def download_file_from_shared_record(conn, %{"subscription_id" => subscription_id, "shared_record_id" => shared_record_id, "file_id" => file_id}) do
    shared_record = SharedRecords.get_record!(subscription_id, shared_record_id) |> DeerStorage.Repo.preload([:deer_record, :subscription])
