defmodule DeerStorage.FeatureFlags do
  def registration_enabled?, do: System.get_env("FEATURE_REGISTRATION") == "1"

  def promote_first_user_to_admin_enabled?,
    do: System.get_env("FEATURE_AUTOCONFIRM_AND_PROMOTE_FIRST_USER_TO_ADMIN") == "1"

  def mailing_enabled? do
    result =
      present_env?("POW_MAILGUN_BASE_URI") &&
  ...
  def mailing_disabled? do
    result =
      empty_env?("POW_MAILGUN_BASE_URI") ||
